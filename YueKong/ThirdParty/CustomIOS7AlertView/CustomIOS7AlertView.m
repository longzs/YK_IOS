...
//    dialogView.layer.transform = CATransform3DMakeScale(1.3f, 1.3f, 1.0); //by wangxun
    dialogView.layer.transform = CATransform3DMakeScale(1.1f, 1.1f, 1.0);
...
//                         dialogView.layer.transform = CATransform3DConcat(currentTransform, CATransform3DMakeScale(0.6f, 0.6f, 1.0)); //by wangxun
...
- (void)addButtonsToView: (UIView *)container
{
    ...
    for (int i=0; i<[buttonTitles count]; i++) {
        ...
        [closeButton.titleLabel setFont:[UIFont boldSystemFontOfSize:18.0f]];   //from 14.f
        ...
        //add by wangxun
        if (i > 0) {
            UIView *lineView = [[UIView alloc] initWithFrame:CGRectMake(closeButton.frame.origin.x, closeButton.frame.origin.y, 1, closeButton.frame.size.height)];
            lineView.backgroundColor = [UIColor colorWithRed:198.0/255.0 green:198.0/255.0 blue:198.0/255.0 alpha:1.0f];
